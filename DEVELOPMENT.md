...
```bash
git remote add encore encore://sportsync-pro-app-qvy2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/sportsync-pro-app-qvy2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/sportsync-pro-app-qvy2/settings/integrations/github)
